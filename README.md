...
#### ☑ 主页标题
![主页标题](/img/w-1.png "主页主题.png")

#### ☑页面名称后跟组织名称

![页面名称后跟组织名称](/img/w-2.png "页面名称后跟组织名称.png")

#### ☑页面名称，包括流程中的步骤

![页面名称，包括流程中的步骤](/img/w-3.png "页面名称，包括流程中的步骤.png")
----
...
![标题不足](/img/w-4.png "headings-poor.png")

✅使用标题和副标题

![使用标题和副标题](/img/w-5.png "headings-good.png")
...
![正在为手机充电](/img/w-6.png "phone_charging.png")为手机充电：使用随附的电缆和电源适配器将手机连接至电源插座。  **图片的替代文本**：“正在为手机充电” 


✅内容丰富

![输入图片说明](/img/w-7.png "phone_charging (2).png")为手机充电：使用随附的电缆和电源适配器将手机连接至电源插座。  **图片的替代文本** ：“将电缆插入电话的底部边缘。”
...
* 未确定的索偿-需要更多信息
* 索赔被拒-不赔款
![理赔流程](/img/w-9.png "clear_text_diagram.png")
...
![home](/img/b-1.png "屏幕截图.png")

![register](/img/b-2.png "屏幕截图.png") 

![story](/img/b-3.png "屏幕截图.png")
...
![Demo](/img/b-4.png "屏幕截图.png")
![Menu](/img/b-5.png "屏幕截图.png")

**简洁明了，用户能够很快的理解到想要传达的信息😉**

![colorless](/img/b-6.png "屏幕截图.png")
...
### 3.没有使用链接文本描述目标页面
![href-wrong](/img/b-7.png "屏幕截图.png")
...
### 6.总体的内容设计非常简洁易懂
![story](/img/b-10.png "屏幕截图.png")
**不仅仅设计简洁，而且文字编写也是非常平易近人，不会让用户拥有距离感与陌生感😄**

![story-where](/img/b-11.png "屏幕截图.png")
